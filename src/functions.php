 ...
 */
 	...
 	// Register Medspa Theme Customizer
 	function medspa_customize_register( $wp_customize ) {
		...
		$colors[] = array(
		  ...
		  'default' => '#333',
		  'label' => __('Content Text Color', 'Monterey')
		);
		$colors[] = array(
		  'slug'=>'content_link_color', 
		  'default' => '#88C34B',
		  'label' => __('Content Link Color', 'Monterey')
		);
		$colors[] = array(
		  'slug'=>'content_topnav_color', 
		  'default' => '#ffffff',
		  'label' => __('Top Navigation Bar Background Color', 'Monterey')
		);
		$colors[] = array(
		  'slug'=>'content_topnavlinks_color', 
		  'default' => '#000000',
		  'label' => __('Top Navigation Bar Links Color', 'Monterey')
		);
		$colors[] = array(
		  'slug'=>'content_footer_color', 
		  'default' => '#ffffff',
		  'label' => __('Footer Background Color', 'Monterey')
		);
		$colors[] = array(
		  'slug'=>'content_footerlinks_color', 
		  'default' => '#ffffff',
		  'label' => __('Footer Links Color', 'Monterey')
		);
